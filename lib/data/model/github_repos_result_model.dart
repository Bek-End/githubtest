...
part 'github_repos_result_model.g.dart';

@JsonSerializable()
class GithubReposResultModel extends Equatable {
  const GithubReposResultModel({
  ...
  @override
  List<Object?> get props => [totalCount, incompleteResults, githubRepos];

  factory GithubReposResultModel.fromJson(Map<String, dynamic> json) =>
      _$GithubReposResultModelFromJson(json);

  Map<String, dynamic> toJson() => _$GithubReposResultModelToJson(this);
}
